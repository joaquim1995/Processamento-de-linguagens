...
void PintaCircf(IVC *imagem,Coordenadas cordU, unsigned int radius,RGB core)
{
    ...
    PintPonto(imagem,cordU.x, cordU.y + radius,core);
    PintLinha(imagem, cordU.x, cordU.y, cordU.x,  cordU.y + y, core);
    PintPonto(imagem,cordU.x, cordU.y - radius,core);
	PintLinha(imagem, cordU.x, cordU.y, cordU.x,  cordU.y - y, core);
    PintPonto(imagem,cordU.x + radius, cordU.y,core);
	PintLinha(imagem, cordU.x, cordU.y, cordU.x + y,  cordU.y, core);
    PintPonto(imagem,cordU.x - radius, cordU.y,core);
	PintLinha(imagem, cordU.x, cordU.y, cordU.x -y,  cordU.y, core);
    ...
    while(x < y) 
    {
		...
		//7º quadrante
        PintPonto(imagem,cordU.x + x, cordU.y + y,core);
        PintLinha(imagem, cordU.x, cordU.y, cordU.x + x,  cordU.y + y, core);
        PintLinha(imagem, cordU.x -x, cordU.y -y, cordU.x + x,  cordU.y + y, core);
		...
		//8º quadrante
		PintPonto(imagem,cordU.x + y, cordU.y + x,core);
        PintLinha(imagem, cordU.x, cordU.y, cordU.x + y,  cordU.y + x, core);
		PintLinha(imagem, cordU.x - y, cordU.y - x, cordU.x + y,  cordU.y + x, core);
	...
	if(radius == 0);
	else PintaCircf(imagem,cordU, radius - 1, core);
}
